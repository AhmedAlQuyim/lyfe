...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    // On success, browser follows OAuth redirect — no client-side navigation needed
  };
  ...
  return (
    <div className="min-h-screen bg-bg dark:bg-bg-dark flex flex-col items-center justify-center px-5 py-12">
      ...
      >
        <h2 className="text-[20px] font-bold font-display text-text dark:text-text-dark mb-1">Welcome back</h2>
        <p className="text-[13px] text-muted dark:text-muted-dark mb-6">Sign in to continue</p>
